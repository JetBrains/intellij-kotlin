...
expect interface <!LINE_MARKER("descr='Has actuals in JVM'"), LINE_MARKER("descr='Is subclassed by A [common-2] B [jvm]'")!>C<!> {
    fun <!LINE_MARKER("descr='Has actuals in JVM'")!>common_2_C<!>()
}

actual interface <!LINE_MARKER("descr='Has declaration in common module'"), LINE_MARKER("descr='Is implemented by B [jvm]'")!>A<!> : C {
