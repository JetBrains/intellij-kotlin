...
expect interface <!LINE_MARKER("descr='Has actuals in JVM'"), LINE_MARKER("descr='Is subclassed by B [common-2] Case_2_3'")!>A_Common<!> {
...
actual interface <!LINE_MARKER("descr='Has declaration in common module'"), LINE_MARKER("descr='Is implemented by Case_2_3'")!>B<!> : A {
