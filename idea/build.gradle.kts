...
dependencies {
    ...
    jpsLikeJarDependency("org.jetbrains:jetCheck:0.2.2", JpsDepScope.TEST) // 'intellij.markdown' dependency
    ...
    jpsLikeJarDependency("org.jetbrains:markdown:0.1.41", JpsDepScope.COMPILE)
