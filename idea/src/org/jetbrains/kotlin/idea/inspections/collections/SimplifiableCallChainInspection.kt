...
class SimplifiableCallChainInspection : AbstractCallChainChecker() {
    ...
    companion object {
        ...
        private val conversions = listOf(
            ...
            Conversion("kotlin.collections.sorted", "kotlin.collections.first", "minOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sorted", "kotlin.collections.last", "maxOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sortedDescending", "kotlin.collections.first", "maxOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sortedDescending", "kotlin.collections.last", "minOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sortedBy", "kotlin.collections.first", "minByOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sortedBy", "kotlin.collections.last", "maxByOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sortedByDescending", "kotlin.collections.first", "maxByOrNull", addNotNullAssertion = true),
            Conversion("kotlin.collections.sortedByDescending", "kotlin.collections.last", "minByOrNull", addNotNullAssertion = true),
