...
dependencies {
    ...
    jpsLikeJarDependency(intellijDep(forIde = true), JpsDepScope.COMPILE, { includeJars("platform-concurrency") }) // 'intellij.java.debugger.impl' dependency
    jpsLikeJarDependency(intellijCoreDep(), JpsDepScope.COMPILE) // 'intellij.java.debugger.impl' dependency
    jpsLikeJarDependency(intellijDep(forIde = true), JpsDepScope.COMPILE, { includeJars("platform-core-ui") }) // 'intellij.java.debugger.impl' dependency
    ...
    jpsLikeJarDependency(intellijDep(forIde = true), JpsDepScope.COMPILE, { includeJars("platform-util-ui") }) // 'intellij.java.debugger.impl' dependency
    jpsLikeJarDependency("org.jetbrains:annotations:19.0.0", JpsDepScope.COMPILE) // 'intellij.java.debugger.impl' dependency
    ...
    jpsLikeJarDependency("org.jetbrains.intellij.deps:asm-all:8.0.1", JpsDepScope.COMPILE, { isTransitive = false }) // 'intellij.java.coverage' dependency
    jpsLikeJarDependency("org.jetbrains.intellij.deps:trove4j:1.0.20200330", JpsDepScope.COMPILE) // 'intellij.java.coverage' dependency
    jpsLikeJarDependency("org.jetbrains.intellij.deps:intellij-coverage-agent:1.0.512", JpsDepScope.COMPILE, { isTransitive = false }) // 'intellij.java.coverage' dependency
    jpsLikeJarDependency("org.jetbrains.intellij.deps:intellij-test-discovery-agent:1.0.512", JpsDepScope.COMPILE, { isTransitive = false }) // 'intellij.java.coverage' dependency
