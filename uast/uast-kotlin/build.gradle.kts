...
dependencies {
    ...
    jpsLikeJarDependency("org.jetbrains:annotations:19.0.0", JpsDepScope.COMPILE) // 'intellij.platform.uast' dependency
    ...
    jpsLikeJarDependency("org.jetbrains:annotations:19.0.0", JpsDepScope.TEST) // 'intellij.platform.uast.tests' dependency
