...
dependencies {
    ...
    jpsLikeJarDependency(intellijDep(forIde = true), JpsDepScope.COMPILE, { includeJars("platform-concurrency") }) // 'intellij.platform.lang' dependency
    ...
    jpsLikeJarDependency("org.jetbrains:annotations:19.0.0", JpsDepScope.COMPILE) // 'intellij.platform.lang' dependency
    ...
    jpsLikeJarDependency("org.jetbrains.intellij.deps:gradle-api:6.5.1-java7-sp2", JpsDepScope.COMPILE) // 'intellij.gradle' dependency
