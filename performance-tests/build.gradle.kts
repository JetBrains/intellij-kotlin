...
dependencies {
    ...
    jpsLikeJarDependency("org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.4.0", JpsDepScope.TEST) // 'intellij.platform.analysis.impl' dependency
    ...
    jpsLikeJarDependency("com.fasterxml.jackson.module:jackson-module-kotlin:2.11.0", JpsDepScope.TEST, { isTransitive = false })
